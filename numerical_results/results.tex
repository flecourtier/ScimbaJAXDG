...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \begin{cvgh}[2]{L2}
            ...
            \addseries{DG SIPG}{2}{images/DG/classical_approach/DG_SIPG_P2.csv}

            \addseries{DG NIPG}{1}{images/DG/classical_approach/DG_NIPG_P1.csv}
            \addseries{DG NIPG}{2}{images/DG/classical_approach/DG_NIPG_P2.csv}
            
            \addseries{DG BZ}{1}{images/DG/classical_approach/DG_BZ_P1.csv}
            \addseries{DG BZ}{2}{images/DG/classical_approach/DG_BZ_P2.csv}
